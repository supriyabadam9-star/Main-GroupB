...
export default function BusinessRecResults() {
  ...
  const sortedPolicies = useMemo(() => {
    ...
    return sortBy === "premium"
      ? data.sort((a, b) => a.premium - b.premium)
    ...
    <div className="px-16 py-12 max-w-7xl mx-auto space-y-10">
      ...
      <div className="flex items-center justify-between gap-6">
          <h1 className="text-2xl font-bold text-gray-900">
            Recommended Business Policies
          </h1>

          <div className="w-fit">
            <button
              onClick={() => navigate("/business_insurance_rec")}
              className="
        ...
        {sortedPolicies.map((p, index) => (
          ...
          >
            ...
            <div className="text-right flex flex-col justify-between items-end">
              ...
              <button
                onClick={() => navigate(`/policies/business/${p.policy_id}`)}
                className="
