  ...
  const sortedPolicies = useMemo(() => {
    ...
    if (sortBy === "premium") {
      return data.sort((a, b) => {
        const aPremium =
          a.monthly_premium ??
          (a.annual_premium ? a.annual_premium / 12 : Infinity);
        const bPremium =
          b.monthly_premium ??
          (b.annual_premium ? b.annual_premium / 12 : Infinity);
      ...
      <div className="space-y-8">
        {sortedPolicies.map((p, index) => {
          const monthlyPremium =
            p.monthly_premium ??
            (p.annual_premium ? p.annual_premium / 12 : 0);
              ...
              <div className="text-right flex flex-col justify-between items-end">
                <div>
                  <p className="text-2xl font-extrabold text-indigo-600">
                    ₹ {Math.round(monthlyPremium).toLocaleString("en-IN")}
                  </p>
